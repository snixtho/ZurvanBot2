...
namespace ZurvanBot.Util.HTTP
{
    public class HTTPSRequest
    {
        ...
        /// </summary>
        public string Method { get { return _method.ToUpper(); } set { _method = value; } }
        ...
        private bool SetupNewStream()
        {
            ...
            var retries = 0;
            do _tcpClient.Connect(URL.Host, ConnectionPort);
            while (!_tcpClient.Connected && ++retries < ConnectionRetries);
